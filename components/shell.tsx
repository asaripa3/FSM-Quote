...
export function Footer() { return <footer className="site-footer page-width"><BrandLink className="site-brand"><ExaLogo /><span className="brand-divider" /><strong>FSMpedia</strong></BrandLink><span>The live knowledge layer for field technicians.</span><span className="micro-label">RESEARCH BY EXA · DECISIONS BY YOUR TECHNICIAN</span></footer>; }
