...
export function ReceiptPrinter({ pack, lines, quote, onClose, company = "" }: { pack: TradePack; lines: QuoteLine[]; quote: ReturnType<typeof buildQuote>; onClose: () => void; company?: string }) {
  ...
  const download = async () => {
    ...
    try { const { downloadQuotePdf } = await import("@/lib/quote-pdf"); await downloadQuotePdf(pack, lines, quote, company); }
