...
Return {summary:string,equipment:string,laborHours:{min:number,max:number}|null,parts:[{description,quantity,sku,equipment,kind:"part"|"tool",intent:{rawContext,manufacturer,fixture,symptom,suspectedPart,possibleFamily,exactModel,route,constraints:[{field,value}]}}],questions:string[]}.
